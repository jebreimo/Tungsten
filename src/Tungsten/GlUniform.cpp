...
namespace Tungsten
{
    ...
    {
        get_ogl_wrapper().uniform2_iv(location, 1, vec.values);
        THROW_IF_GL_ERROR();
    }

    void set_uniform(int32_t location, const Xyz::Vector3I& vec)
    {
        get_ogl_wrapper().uniform3_iv(location, 1, vec.values);
        THROW_IF_GL_ERROR();
    }

    void set_uniform(int32_t location, const Xyz::Vector4I& vec)
    {
        get_ogl_wrapper().uniform4_iv(location, 1, vec.values);
        THROW_IF_GL_ERROR();
    }

    void set_uniform(int32_t location, const Xyz::Vector2F& vec)
    {
        get_ogl_wrapper().uniform2_fv(location, 1, vec.values);
        THROW_IF_GL_ERROR();
    }

    void set_uniform(int32_t location, const Xyz::Vector3F& vec)
    {
        get_ogl_wrapper().uniform3_fv(location, 1, vec.values);
        THROW_IF_GL_ERROR();
    }

    void set_uniform(int32_t location, const Xyz::Vector4F& vec)
    {
        get_ogl_wrapper().uniform4_fv(location, 1, vec.values);
        THROW_IF_GL_ERROR();
    }
    ...
    void set_uniform(int32_t location, Xyz::Matrix2F mat, bool transpose)
    {
        ...
        get_ogl_wrapper().uniform_matrix2_fv(location, 1, false, mat.values);
        THROW_IF_GL_ERROR();
    }
    ...
    void set_uniform(int32_t location, Xyz::Matrix3F mat, bool transpose)
    {
        if (transpose)
            Xyz::transpose_inplace(mat);
        get_ogl_wrapper().uniform_matrix3_fv(location, 1, false, mat.values);
        THROW_IF_GL_ERROR();
    }
    ...
    void set_uniform(int32_t location, Xyz::Matrix4F mat, bool transpose)
    {
        if (transpose)
            Xyz::transpose_inplace(mat);
        get_ogl_wrapper().uniform_matrix4_fv(location, 1, false, mat.values);
        THROW_IF_GL_ERROR();
    }
}
