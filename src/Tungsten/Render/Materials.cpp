...
//****************************************************************************
#include "Tungsten/Render/Materials.hpp"
...
namespace Tungsten
{
    namespace
    {
        ...
        constexpr std::pair<DefaultMaterial, ColorMaterial> DEFAULT_MATERIALS[] = {
            ...
            {
                DefaultMaterial::YELLOW_PLASTIC,
                {
                    {0.0f, 0.0f, 0.0f},
                    {0.5f, 0.5f, 0.0f},
                    {0.60f, 0.60f, 0.50f},
